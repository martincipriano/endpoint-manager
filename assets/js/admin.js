...
(function() {
    ...
    function showPreviewModal(urlTemplate, params) {
        ...
        if (wpbyemData.excludeAdminsEndpoints) {
            var paramStepNote = document.createElement('p');
            paramStepNote.className = 'wpb-emp-preview-admin-note';
            paramStepNote.innerHTML = '<strong>Your role bypasses blocked endpoints.</strong> Responses here may not reflect what visitors see. Adjust this in <a href="' + wpbyemData.settingsUrl + '">Settings</a> when testing.';
            modal.appendChild(paramStepNote);
        }
    ...
    function showResponseModal(url) {
        ...
        if (wpbyemData.excludeAdminsEndpoints) {
            ...
            adminNote.innerHTML = '<strong>Your role bypasses blocked endpoints.</strong> Responses here may not reflect what visitors see. Adjust this in <a href="' + wpbyemData.settingsUrl + '">Settings</a> when testing.';
