	...
	<div class="rest-api-routes" style="display: none;">
		...
		<div class="rest-api-route" data-methods="<?php echo esc_attr( implode( ',', $em_route_data['methods'] ) ); ?>" data-type="<?php echo esc_attr( $em_route_data['is_dynamic'] ? 'dynamic' : 'static' ); ?>">
			<div class="route-row">
				...
				<button type="button"
					class="route-preview<?php echo $em_route_data['is_dynamic'] ? ' route-preview--dynamic' : ''; ?>"
					data-preview-url="<?php echo esc_url( $em_route_data['preview_url'] ); ?>"
					<?php if ( $em_route_data['is_dynamic'] ) : ?>
					data-preview-params="<?php echo esc_attr( wp_json_encode( $em_route_data['preview_params'] ) ); ?>"
					<?php endif; ?>
